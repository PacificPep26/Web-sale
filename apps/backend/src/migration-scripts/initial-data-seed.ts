...
export default async function initial_data_seed({
  ...
  const IMAGES: Record<string, string[]> = {
    ...
    "blue-light-filter-glasses": ["1574258495973-f010dfbb5371", "1577803645773-f96470509666"],
    "round-retro-sunglasses": ["1508296695146-257a814070b4", "1473496169904-658ba7c44d8a"],
