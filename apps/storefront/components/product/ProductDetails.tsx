    ...
    <div className="container-page grid gap-8 py-6 pb-20 md:grid-cols-12 md:gap-12 md:py-8 md:pb-12">
      ...
      <div className="md:col-span-7 md:sticky md:top-24 md:self-start">
        <div className="flex gap-4 items-start w-full">
            ...
            <div className="hidden w-20 shrink-0 flex-col gap-3 sm:flex">
              {images.map((im, i) => (
                <button
                  ...
                  className="relative aspect-square w-20 overflow-hidden border border-token transition-opacity bg-card rounded-sm"
          ...
          <div className="relative aspect-[4/5] flex-1 w-full overflow-hidden bg-card flex items-center justify-center rounded-sm">
